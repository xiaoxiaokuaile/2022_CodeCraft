...
本人是用C++写的方案, 不过比赛期间出现了死循环一直没能找到原因,纠正过来之后会放出源代码。

####2.3.JAVA 版本方案

队友用的JAVA写的代码,可以跑通出成绩,优化方案都是一起商量然后各自实现,源代码初赛榜出成绩之后就放出。
...
参加该比赛主要是为了拿一个免机考卡,虽然没能如愿吧,不过还是学到了很多知识以及DeBug能力,这种比赛也是第一次参加,需要学习的地方还有很多。
